...
urlpatterns = [
    ...
    path('questions/', include([
        ...
        path('<uuid:question_id>/votes/create/', views.CreateVoteQuestion.as_view(), name='create_vote_question'),
        path('<uuid:question_id>/votes/delete/', views.DeleteVoteQuestion.as_view(), name='delete_vote_question'),
    ...
    path('answers/', include([
        ...
        path('<uuid:answer_id>/votes/create/', views.CreateVoteAnswer.as_view(), name='create_vote_answer'),
        path('<uuid:answer_id>/votes/delete/', views.DeleteVoteAnswer.as_view(), name='delete_vote_answer'),
    ]))
]
